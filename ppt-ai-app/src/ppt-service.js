...
function costBreakdownPreviewScene({ slide, index, total }) {
  ...
  const role = index === 0 ? "cover" : index === total - 1 ? "closing" : ["structure", "drivers", "roadmap", "loop", "matrix"][(index - 1) % 5];
