  ...
  <script>
    ...
    function normalizedTemplateVisual(visual = {}) {
      return {
        ...
        layout: ["top-band", "left-rail", "hero", "executive", "academy", "venture", "marketing", "status-report", "red-gold", "education-course", "feature-priority-matrix", "experience-journey-map", "capability-radar-map", "investor-update-progress-sync", "enterprise-digital-blueprint", "operating-problem-tree", "knowledge-blackboard", "exam-review-keypoints", "corporate-training", "onboarding-guide", "annual-summary", "quarterly-dashboard", "quarterly-diagnosis", "quarterly-action-loop", "industry-research", "industry-trend-forecast", "strategy-swot-map", "bi-executive-cockpit", "user-path-funnel", "market-trend-radar"].includes(visual.layout) ? visual.layout : "top-band",
    ...
    function resolveTemplateCardVisual(baseVisual, theme, fallbackVisual) {
      ...
      const merged = {
        ...
        layout: ["top-band", "left-rail", "hero", "executive", "academy", "venture", "marketing", "status-report", "red-gold", "education-course", "feature-priority-matrix", "experience-journey-map", "capability-radar-map", "investor-update-progress-sync", "enterprise-digital-blueprint", "operating-problem-tree", "knowledge-blackboard", "exam-review-keypoints", "corporate-training", "onboarding-guide", "annual-summary", "quarterly-dashboard", "quarterly-diagnosis", "quarterly-action-loop", "industry-research", "industry-trend-forecast", "strategy-swot-map", "bi-executive-cockpit", "user-path-funnel", "market-trend-radar"].includes(theme.visual.layout)
          ? theme.visual.layout
          : baseVisual.layout,
