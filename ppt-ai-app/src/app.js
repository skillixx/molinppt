...
<head>
  ...
  <style>
    ...
    * { box-sizing: border-box; }
    ...
    .template-thumb[data-layout="brand-story-editorial"] { background: linear-gradient(135deg, #ece6dd 0%, #f8f3ea 58%, #dfd5c8 100%); }
    .template-thumb[data-layout="brand-story-editorial"]::before { background: repeating-linear-gradient(0deg, rgba(23,27,38,.035) 0 1px, transparent 1px 7px), repeating-linear-gradient(90deg, rgba(23,27,38,.025) 0 1px, transparent 1px 32px); }
    .template-thumb[data-layout="brand-story-editorial"] .template-thumb-back { left: 8%; right: 10%; top: 10%; bottom: 20%; border-radius: 2px; background: #fffdf9; border: 1px solid rgba(42,47,63,.22); transform: rotate(-5deg); box-shadow: 0 16px 26px rgba(23,27,38,.12); }
    .template-thumb[data-layout="brand-story-editorial"] .template-thumb-cover { left: 14%; right: 20%; top: 18%; bottom: 13%; border-radius: 2px; background: #f6f1ea; border: 1px solid rgba(42,47,63,.28); box-shadow: 0 18px 34px rgba(23,27,38,.16); }
    .template-thumb[data-layout="brand-story-editorial"] .template-thumb-cover::before { content: ""; position: absolute; left: 10%; right: 9%; top: 13%; height: 2px; background: var(--thumb-title); box-shadow: 0 22px 0 rgba(199,130,90,.85), 0 82px 0 rgba(23,27,38,.18), 0 108px 0 rgba(23,27,38,.12); }
    .template-thumb[data-layout="brand-story-editorial"] .template-thumb-content { left: 20%; top: 33%; width: 38%; color: var(--thumb-title); }
    .template-thumb[data-layout="brand-story-editorial"] .template-thumb-heading { max-width: 100%; font-size: 18px; line-height: .96; color: var(--thumb-title); text-shadow: none; }
    .template-thumb[data-layout="brand-story-editorial"] .template-thumb-summary { color: var(--thumb-body); max-width: 100%; }
    .template-thumb[data-layout="brand-story-editorial"] .template-thumb-image { right: 24%; top: 31%; width: 20%; height: 38%; border-radius: 0; background: linear-gradient(145deg, #232731, #5a514c 62%, #c7825a); box-shadow: 8px 9px 0 rgba(199,130,90,.18); opacity: 1; }
    .template-thumb[data-layout="brand-story-editorial"] .template-thumb-image::before { background: radial-gradient(circle at 50% 24%, #d5a786 0 14%, transparent 15%), radial-gradient(ellipse at 50% 86%, #171b26 0 36%, transparent 37%); }
    .template-thumb[data-layout="brand-story-editorial"] .template-thumb-band { left: 19%; right: 45%; top: 72%; bottom: auto; height: 2px; background: var(--thumb-title); }
    .template-thumb[data-layout="brand-story-editorial"] .template-thumb-wave { left: 20%; right: 42%; bottom: 19%; height: 10%; background: linear-gradient(90deg, var(--thumb-accent) 0 8%, transparent 8% 26%, var(--thumb-title) 26% 34%, transparent 34% 52%, var(--thumb-accent) 52% 60%, transparent 60%); clip-path: none; opacity: .9; }
    .template-thumb[data-layout="brand-story-editorial"] .template-thumb-tag { background: var(--thumb-title); color: #fffdf9; border-radius: 0; }
    .template-thumb[data-layout="luxury-brand-story"] { background: linear-gradient(135deg, #f6f1e8 0%, #fffefa 52%, #e6dbc8 100%); }
    .template-thumb[data-layout="luxury-brand-story"]::before { background: radial-gradient(circle at 74% 22%, rgba(191,160,106,.24), transparent 24%), repeating-linear-gradient(90deg, rgba(24,28,36,.06) 0 1px, transparent 1px 34px), repeating-linear-gradient(0deg, rgba(24,28,36,.04) 0 1px, transparent 1px 30px); }
    .template-thumb[data-layout="luxury-brand-story"] .template-thumb-cover { left: 8%; right: 36%; top: 18%; bottom: 20%; border-radius: 0; background: linear-gradient(135deg, #fffefa, #f6f1e8); border: 1px solid rgba(191,160,106,.42); box-shadow: 0 18px 34px rgba(24,28,36,.14); }
    .template-thumb[data-layout="luxury-brand-story"] .template-thumb-cover::before { content: ""; position: absolute; left: 12%; right: 16%; top: 20%; height: 1px; background: var(--thumb-accent); box-shadow: 0 25px 0 rgba(191,160,106,.34), 0 50px 0 rgba(191,160,106,.20); }
    .template-thumb[data-layout="luxury-brand-story"] .template-thumb-image { right: 9%; top: 16%; width: 27%; height: 52%; border-radius: 0; background: linear-gradient(180deg, rgba(255,254,250,.1), rgba(24,28,36,.18)), linear-gradient(135deg, var(--thumb-primary), var(--thumb-secondary)); border: 1px solid rgba(191,160,106,.45); box-shadow: 0 16px 30px rgba(24,28,36,.18); }
    .template-thumb[data-layout="luxury-brand-story"] .template-thumb-image::after { left: 18%; right: 18%; bottom: 16%; height: 1px; background: rgba(255,254,250,.76); box-shadow: 0 -20px 0 rgba(255,254,250,.46), 0 -40px 0 rgba(191,160,106,.36); }
    .template-thumb[data-layout="luxury-brand-story"] .template-thumb-wave { height: 16%; background: linear-gradient(90deg, rgba(24,28,36,.82), rgba(191,160,106,.78), rgba(24,28,36,.18)); clip-path: polygon(0 64%, 22% 50%, 44% 60%, 64% 44%, 100% 58%, 100% 100%, 0 100%); }
    .template-thumb[data-layout="luxury-brand-story"] .template-thumb-tag { background: var(--thumb-primary); color: #fffefa; border: 1px solid rgba(191,160,106,.5); }
    .template-thumb[data-layout="growth-marketing-lab"] { background: linear-gradient(135deg, #ecfdf5, #fff 52%, #fff4ea); }
    .template-thumb[data-layout="growth-marketing-lab"]::before { background:
      radial-gradient(circle at 78% 24%, color-mix(in srgb, var(--thumb-accent) 24%, transparent), transparent 24%),
      radial-gradient(circle at 16% 84%, color-mix(in srgb, var(--thumb-primary) 20%, transparent), transparent 26%),
      repeating-linear-gradient(90deg, rgba(6,51,39,.055) 0 1px, transparent 1px 34px); }
    .template-thumb[data-layout="growth-marketing-lab"] .template-thumb-cover { left: 9%; right: 36%; top: 22%; bottom: 24%; border-radius: 18px; background: linear-gradient(135deg, var(--thumb-primary), color-mix(in srgb, var(--thumb-accent) 46%, var(--thumb-primary) 54%)); box-shadow: 0 18px 28px rgba(6,51,39,.18); }
    .template-thumb[data-layout="growth-marketing-lab"] .template-thumb-cover::before { content: ""; position: absolute; left: 15%; right: 18%; top: 28%; height: 8px; border-radius: 999px; background: rgba(255,255,255,.88); box-shadow: 0 18px 0 rgba(255,255,255,.56), 0 36px 0 rgba(255,255,255,.36); }
    .template-thumb[data-layout="growth-marketing-lab"] .template-thumb-image { right: 10%; top: 23%; width: 27%; aspect-ratio: 1/1; height: auto; border-radius: 50%; background: conic-gradient(var(--thumb-primary), #22c55e, var(--thumb-accent), var(--thumb-primary)); box-shadow: inset 0 0 0 20px #fff, 0 16px 28px rgba(6,51,39,.16); }
    .template-thumb[data-layout="growth-marketing-lab"] .template-thumb-wave { height: 20%; background: linear-gradient(90deg, color-mix(in srgb, var(--thumb-primary) 84%, transparent), color-mix(in srgb, var(--thumb-accent) 74%, transparent)); clip-path: polygon(0 68%, 20% 48%, 38% 58%, 58% 38%, 79% 54%, 100% 34%, 100% 100%, 0 100%); }
    .template-thumb[data-layout="growth-marketing-lab"] .template-thumb-tag { background: var(--thumb-accent); color: #fff; }
    ...
    .template-thumb[data-layout="public-course-enrollment"] { background: linear-gradient(135deg, #f7fbff 0%, var(--thumb-bg) 58%, #e3f8fb 100%); }
    .template-thumb[data-layout="public-course-enrollment"]::before { background:
      radial-gradient(circle at 82% 20%, color-mix(in srgb, var(--thumb-secondary) 28%, transparent), transparent 26%),
      radial-gradient(circle at 14% 82%, color-mix(in srgb, var(--thumb-accent) 18%, transparent), transparent 29%),
      repeating-linear-gradient(90deg, rgba(23,58,106,.05) 0 1px, transparent 1px 30px); }
    .template-thumb[data-layout="public-course-enrollment"] .template-thumb-cover { left: 9%; right: 28%; top: 20%; bottom: 20%; border-radius: 18px; background: linear-gradient(135deg, color-mix(in srgb, var(--thumb-primary) 92%, #061528 8%), color-mix(in srgb, var(--thumb-secondary) 32%, var(--thumb-primary) 68%)); box-shadow: 0 16px 30px rgba(15,35,59,.16); }
    .template-thumb[data-layout="public-course-enrollment"] .template-thumb-image { right: 9%; top: 23%; width: 24%; height: 46%; border-radius: 18px; background: linear-gradient(135deg, #fff, color-mix(in srgb, var(--thumb-secondary) 12%, #fff 88%)); border: 1px solid rgba(23,58,106,.12); box-shadow: 0 14px 26px rgba(15,35,59,.14); }
    .template-thumb[data-layout="public-course-enrollment"] .template-thumb-image::before { content: ""; position: absolute; left: 18%; top: 22%; width: 42%; height: 12%; border-radius: 999px; background: var(--thumb-primary); box-shadow: 0 30px 0 var(--thumb-secondary), 42px 58px 0 var(--thumb-accent); }
    .template-thumb[data-layout="public-course-enrollment"] .template-thumb-wave { left: 9%; right: 9%; bottom: 13%; height: 7%; border-radius: 999px; background: linear-gradient(90deg, var(--thumb-primary), var(--thumb-secondary), var(--thumb-accent)); clip-path: none; }
    .template-thumb[data-layout="public-course-enrollment"] .template-thumb-tag { background: var(--thumb-accent); color: #fff; }
    ...
    .template-thumb[data-layout="data-governance-standard"] { background: linear-gradient(135deg, #f7fbfd 0%, var(--thumb-bg) 58%, #e8f5f7 100%); }
    .template-thumb[data-layout="data-governance-standard"]::before { background: repeating-linear-gradient(90deg, color-mix(in srgb, var(--thumb-primary) 8%, transparent) 0 1px, transparent 1px 30px), repeating-linear-gradient(0deg, color-mix(in srgb, var(--thumb-accent) 7%, transparent) 0 1px, transparent 1px 28px), radial-gradient(circle at 78% 22%, color-mix(in srgb, var(--thumb-accent) 18%, transparent), transparent 25%); }
    .template-thumb[data-layout="data-governance-standard"] .template-thumb-cover { left: 8%; right: 8%; top: 15%; bottom: 13%; border-radius: 18px; background: rgba(255,255,255,.95); border: 1px solid color-mix(in srgb, var(--thumb-primary) 14%, transparent); box-shadow: 0 16px 30px rgba(16,42,67,.12); }
    .template-thumb[data-layout="data-governance-standard"] .template-thumb-band { left: 9%; right: 9%; top: 15%; height: 3%; border-radius: 999px; background: linear-gradient(90deg, var(--thumb-primary), var(--thumb-accent), var(--thumb-secondary)); }
    .template-thumb[data-layout="data-governance-standard"] .template-thumb-image { right: 10%; top: 23%; width: 34%; height: 42%; border-radius: 50%; background: radial-gradient(circle at 50% 50%, var(--thumb-primary) 0 16%, transparent 17%), radial-gradient(circle at 18% 25%, var(--thumb-accent) 0 8%, transparent 9%), radial-gradient(circle at 82% 25%, var(--thumb-secondary) 0 8%, transparent 9%), radial-gradient(circle at 20% 78%, var(--thumb-primary) 0 8%, transparent 9%), radial-gradient(circle at 80% 78%, var(--thumb-accent) 0 8%, transparent 9%), conic-gradient(from 24deg, color-mix(in srgb, var(--thumb-accent) 22%, transparent), color-mix(in srgb, var(--thumb-secondary) 22%, transparent), color-mix(in srgb, var(--thumb-primary) 16%, transparent), color-mix(in srgb, var(--thumb-accent) 22%, transparent)); border: 1px solid color-mix(in srgb, var(--thumb-primary) 16%, transparent); box-shadow: none; }
    .template-thumb[data-layout="data-governance-standard"] .template-thumb-wave { left: 12%; right: 52%; bottom: 24%; height: 10%; background: linear-gradient(90deg, var(--thumb-accent) 0 18%, transparent 18% 28%, var(--thumb-secondary) 28% 46%, transparent 46% 57%, var(--thumb-primary) 57% 72%, transparent 72%); clip-path: none; opacity: .92; }
    .template-thumb[data-layout="data-governance-standard"] .template-thumb-tag { background: var(--thumb-accent); color: #fff; }
    .template-thumb[data-layout="data-insight-workbench"] { background: linear-gradient(135deg, #f8fafc 0%, var(--thumb-bg) 56%, #edf6f4 100%); }
    .template-thumb[data-layout="data-insight-workbench"]::before { background: repeating-linear-gradient(90deg, color-mix(in srgb, var(--thumb-primary) 8%, transparent) 0 1px, transparent 1px 30px), repeating-linear-gradient(0deg, color-mix(in srgb, var(--thumb-secondary) 7%, transparent) 0 1px, transparent 1px 28px), radial-gradient(circle at 80% 18%, color-mix(in srgb, var(--thumb-accent) 20%, transparent), transparent 24%); }
    .template-thumb[data-layout="data-insight-workbench"] .template-thumb-cover { left: 8%; right: 8%; top: 15%; bottom: 13%; border-radius: 18px; background: rgba(255,255,255,.96); border: 1px solid color-mix(in srgb, var(--thumb-primary) 14%, transparent); box-shadow: 0 16px 30px rgba(15,23,42,.12); }
    .template-thumb[data-layout="data-insight-workbench"] .template-thumb-band { left: 9%; right: 9%; top: 15%; height: 3%; border-radius: 999px; background: linear-gradient(90deg, var(--thumb-primary), var(--thumb-secondary), var(--thumb-accent)); }
    .template-thumb[data-layout="data-insight-workbench"] .template-thumb-image { right: 10%; top: 24%; width: 35%; height: 40%; border-radius: 15px; background: radial-gradient(circle at 56% 35%, transparent 0 17%, var(--thumb-accent) 18% 21%, transparent 22%), linear-gradient(38deg, transparent 0 55%, var(--thumb-primary) 56% 60%, transparent 61%), radial-gradient(circle at 20% 68%, var(--thumb-secondary) 0 4%, transparent 5%), radial-gradient(circle at 42% 52%, var(--thumb-accent) 0 4%, transparent 5%), radial-gradient(circle at 66% 42%, var(--thumb-secondary) 0 4%, transparent 5%), radial-gradient(circle at 82% 28%, #ef4444 0 5%, transparent 6%), #f8fafc; border: 1px solid color-mix(in srgb, var(--thumb-primary) 16%, transparent); box-shadow: none; }
    .template-thumb[data-layout="data-insight-workbench"] .template-thumb-wave { left: 12%; right: 50%; bottom: 24%; height: 10%; background: linear-gradient(90deg, var(--thumb-secondary) 0 10%, transparent 10% 24%, var(--thumb-accent) 24% 34%, transparent 34% 50%, #ef4444 50% 58%, transparent 58% 73%, var(--thumb-primary) 73% 84%, transparent 84%); clip-path: none; opacity: .94; }
    .template-thumb[data-layout="data-insight-workbench"] .template-thumb-tag { background: var(--thumb-accent); color: #111827; }
    ...
    .template-thumb[data-layout="pitch-project-return"] { background: linear-gradient(135deg, #111827 0%, #172033 46%, #263246 100%); }
    .template-thumb[data-layout="pitch-project-return"]::before { background: radial-gradient(circle at 78% 18%, color-mix(in srgb, var(--thumb-accent) 34%, transparent), transparent 24%), repeating-linear-gradient(90deg, rgba(255,255,255,.10) 0 1px, transparent 1px 34px), repeating-linear-gradient(0deg, rgba(255,255,255,.07) 0 1px, transparent 1px 30px); }
    .template-thumb[data-layout="pitch-project-return"] .template-thumb-cover { left: 7%; right: 7%; top: 14%; bottom: 12%; border-radius: 18px; background: linear-gradient(135deg, rgba(255,255,255,.96), #f8fbff); border: 1px solid color-mix(in srgb, var(--thumb-accent) 24%, transparent); box-shadow: 0 18px 34px rgba(0,0,0,.24); }
    .template-thumb[data-layout="pitch-project-return"] .template-thumb-band { left: 10%; right: 46%; top: 38%; height: 3%; border-radius: 999px; background: linear-gradient(90deg, var(--thumb-accent), var(--thumb-secondary), transparent); }
    .template-thumb[data-layout="pitch-project-return"] .template-thumb-image { right: 10%; top: 24%; width: 35%; height: 43%; border-radius: 16px; background: radial-gradient(circle at 72% 20%, var(--thumb-accent) 0 9%, transparent 10%), linear-gradient(135deg, transparent 0 46%, color-mix(in srgb, var(--thumb-accent) 36%, transparent) 47% 51%, transparent 52%), linear-gradient(90deg, transparent 0 18%, var(--thumb-secondary) 18% 22%, transparent 22% 45%, var(--thumb-primary) 45% 50%, transparent 50% 72%, var(--thumb-accent) 72% 78%, transparent 78%), #f8fbff; border: 1px solid color-mix(in srgb, var(--thumb-primary) 18%, transparent); box-shadow: none; }
    .template-thumb[data-layout="pitch-project-return"] .template-thumb-wave { left: 12%; right: 13%; bottom: 22%; height: 10%; background: linear-gradient(90deg, var(--thumb-accent) 0 12%, transparent 12% 24%, var(--thumb-secondary) 24% 34%, transparent 34% 48%, var(--thumb-warning) 48% 58%, transparent 58% 72%, var(--thumb-accent) 72% 84%, transparent 84%); clip-path: none; opacity: .94; }
    .template-thumb[data-layout="pitch-project-return"] .template-thumb-tag { background: var(--thumb-accent); color: #111827; }
    ...
    .template-thumb[data-layout="business-model-value-chain"] { background: linear-gradient(135deg, #eef5f3 0%, #ffffff 54%, #e9f7ef 100%); }
    .template-thumb[data-layout="business-model-value-chain"]::before { background: repeating-linear-gradient(90deg, color-mix(in srgb, var(--thumb-primary) 9%, transparent) 0 1px, transparent 1px 30px), repeating-linear-gradient(0deg, color-mix(in srgb, var(--thumb-accent) 8%, transparent) 0 1px, transparent 1px 28px); }
    .template-thumb[data-layout="business-model-value-chain"] .template-thumb-cover { left: 7%; right: 7%; top: 14%; bottom: 12%; border-radius: 18px; background: rgba(255,255,255,.96); border: 1px solid color-mix(in srgb, var(--thumb-primary) 14%, transparent); box-shadow: 0 16px 32px rgba(16,32,51,.13); }
    .template-thumb[data-layout="business-model-value-chain"] .template-thumb-band { left: 8%; right: 8%; top: 14%; height: 3%; border-radius: 999px; background: linear-gradient(90deg, var(--thumb-primary), var(--thumb-accent), var(--thumb-secondary)); }
    .template-thumb[data-layout="business-model-value-chain"] .template-thumb-image { right: 10%; top: 25%; width: 34%; height: 39%; border-radius: 50%; background: radial-gradient(circle at 50% 50%, var(--thumb-primary) 0 17%, transparent 18%), radial-gradient(circle at 50% 9%, var(--thumb-secondary) 0 7%, transparent 8%), radial-gradient(circle at 91% 50%, var(--thumb-accent) 0 7%, transparent 8%), radial-gradient(circle at 50% 91%, var(--thumb-primary) 0 7%, transparent 8%), radial-gradient(circle at 9% 50%, var(--thumb-accent) 0 7%, transparent 8%), conic-gradient(from 20deg, color-mix(in srgb, var(--thumb-accent) 28%, transparent), color-mix(in srgb, var(--thumb-secondary) 24%, transparent), color-mix(in srgb, var(--thumb-primary) 16%, transparent), color-mix(in srgb, var(--thumb-accent) 28%, transparent)); border: 1px dashed color-mix(in srgb, var(--thumb-accent) 46%, transparent); box-shadow: none; }
    .template-thumb[data-layout="business-model-value-chain"] .template-thumb-wave { left: 12%; right: 48%; bottom: 23%; height: 11%; background: linear-gradient(90deg, var(--thumb-primary) 0 10%, transparent 10% 22%, var(--thumb-accent) 22% 34%, transparent 34% 46%, var(--thumb-secondary) 46% 60%, transparent 60% 72%, var(--thumb-primary) 72% 82%, transparent 82%); clip-path: none; opacity: .92; }
    .template-thumb[data-layout="business-model-value-chain"] .template-thumb-tag { background: var(--thumb-accent); color: #062a2a; }
    ...
    .template-thumb[data-layout="sales-enterprise-proposal"] { background: linear-gradient(135deg, #f8fbfd 0%, #f3f7fa 54%, #e6f4f2 100%); }
    .template-thumb[data-layout="sales-enterprise-proposal"]::before { background: repeating-linear-gradient(90deg, color-mix(in srgb, var(--thumb-primary) 9%, transparent) 0 1px, transparent 1px 26px), repeating-linear-gradient(0deg, color-mix(in srgb, var(--thumb-accent) 8%, transparent) 0 1px, transparent 1px 24px); }
    .template-thumb[data-layout="sales-enterprise-proposal"] .template-thumb-cover { left: 7%; right: 7%; top: 13%; bottom: 12%; border-radius: 16px; background: rgba(255,255,255,.96); border: 1px solid color-mix(in srgb, var(--thumb-primary) 14%, transparent); box-shadow: 0 16px 32px rgba(15,47,74,.13); }
    .template-thumb[data-layout="sales-enterprise-proposal"] .template-thumb-band { left: 11%; right: 48%; top: 39%; height: 2.4%; border-radius: 999px; background: linear-gradient(90deg, var(--thumb-accent), var(--thumb-secondary), transparent); }
    .template-thumb[data-layout="sales-enterprise-proposal"] .template-thumb-image { right: 10%; top: 23%; width: 35%; height: 42%; border-radius: 14px; background: radial-gradient(circle at 50% 22%, var(--thumb-primary) 0 9%, transparent 10%), radial-gradient(circle at 21% 56%, var(--thumb-accent) 0 6%, transparent 7%), radial-gradient(circle at 50% 56%, var(--thumb-secondary) 0 6%, transparent 7%), radial-gradient(circle at 79% 56%, var(--thumb-accent) 0 6%, transparent 7%), linear-gradient(90deg, transparent 20%, color-mix(in srgb, var(--thumb-primary) 32%, transparent) 20% 22%, transparent 22% 50%, color-mix(in srgb, var(--thumb-accent) 40%, transparent) 50% 52%, transparent 52% 78%, color-mix(in srgb, var(--thumb-secondary) 44%, transparent) 78% 80%, transparent 80%), #fff; border: 1px solid color-mix(in srgb, var(--thumb-primary) 16%, transparent); box-shadow: none; }
    .template-thumb[data-layout="sales-enterprise-proposal"] .template-thumb-wave { left: 12%; right: 14%; bottom: 22%; height: 10%; background: linear-gradient(90deg, var(--thumb-primary) 0 10%, transparent 10% 24%, var(--thumb-accent) 24% 34%, transparent 34% 48%, var(--thumb-secondary) 48% 58%, transparent 58% 72%, var(--thumb-warning) 72% 82%, transparent 82%); clip-path: none; opacity: .94; }
    .template-thumb[data-layout="sales-enterprise-proposal"] .template-thumb-tag { background: var(--thumb-primary); color: #fff; }
    ...
    .template-thumb[data-layout="executive-deepblue-boardroom"] { background: linear-gradient(135deg, #081426 0%, #10243a 58%, #071a2f 100%); }
    .template-thumb[data-layout="executive-deepblue-boardroom"]::before { background: radial-gradient(circle at 78% 18%, rgba(59,165,199,.24), transparent 24%), radial-gradient(circle at 18% 82%, rgba(200,169,106,.18), transparent 25%), repeating-linear-gradient(90deg, rgba(183,198,214,.09) 0 1px, transparent 1px 28px), repeating-linear-gradient(0deg, rgba(183,198,214,.06) 0 1px, transparent 1px 26px); }
    .template-thumb[data-layout="executive-deepblue-boardroom"] .template-thumb-cover { left: 8%; right: 8%; top: 15%; bottom: 13%; border-radius: 8px; background: linear-gradient(135deg, rgba(16,36,58,.96), rgba(7,26,47,.90)); border: 1px solid rgba(200,169,106,.35); box-shadow: 0 16px 30px rgba(0,0,0,.26); }
    .template-thumb[data-layout="executive-deepblue-boardroom"] .template-thumb-band { left: 8%; right: 37%; top: 15%; height: 6px; background: linear-gradient(90deg, var(--thumb-accent), var(--thumb-secondary)); border-radius: 8px 0 0 0; }
    .template-thumb[data-layout="executive-deepblue-boardroom"] .template-thumb-image { right: 12%; top: 27%; width: 29%; height: 34%; border-radius: 8px; background: linear-gradient(180deg, rgba(7,26,47,.92), rgba(16,36,58,.84)); border: 1px solid rgba(200,169,106,.24); box-shadow: none; }
    .template-thumb[data-layout="executive-deepblue-boardroom"] .template-thumb-image::before { background: linear-gradient(var(--thumb-accent), var(--thumb-accent)) 18% 70% / 10% 28% no-repeat, linear-gradient(var(--thumb-secondary), var(--thumb-secondary)) 36% 58% / 10% 40% no-repeat, linear-gradient(var(--thumb-accent), var(--thumb-accent)) 54% 66% / 10% 32% no-repeat, linear-gradient(var(--thumb-secondary), var(--thumb-secondary)) 72% 48% / 10% 50% no-repeat; }
    .template-thumb[data-layout="executive-deepblue-boardroom"] .template-thumb-wave { left: 12%; right: 44%; bottom: 22%; height: 10%; background: linear-gradient(90deg, var(--thumb-accent) 0 10%, transparent 10% 25%, var(--thumb-secondary) 25% 34%, transparent 34% 50%, var(--thumb-accent) 50% 58%, transparent 58% 75%, var(--thumb-secondary) 75%); clip-path: none; opacity: .95; }
    .template-thumb[data-layout="executive-deepblue-boardroom"] .template-thumb-heading { color: var(--thumb-title); text-shadow: 0 0 12px rgba(59,165,199,.16); }
    .template-thumb[data-layout="executive-deepblue-boardroom"] .template-thumb-date,
    .template-thumb[data-layout="executive-deepblue-boardroom"] .template-thumb-kicker,
    .template-thumb[data-layout="executive-deepblue-boardroom"] .template-thumb-summary { color: color-mix(in srgb, var(--thumb-body) 90%, #ffffff 10%); }
    .template-thumb[data-layout="executive-deepblue-boardroom"] .template-thumb-tag { background: var(--thumb-accent); color: #071a2f; }
  ...
  <script>
    ...
    function templateThumbCopy(display) {
      ...
      const copies = {
        ...
        "pitch-project-return": { date: "2026/10/28", kicker: "CAPITAL 01", title: "收益测算", lines: ["投入产出模型", "合作权益路径"], tag: "招商融资" },
        ...
        "public-courseware": { date: "2026/08/28", kicker: "LIVE CLASS", title: "公开课价值课", lines: ["课程亮点与直播互动", "资料权益与报名路径"], tag: "公开课" },
      ...
      const layoutCopies = {
        ...
        "data-insight-workbench": { date: "2026/11/03", kicker: "INSIGHT 01", title: "分析工作台", lines: ["信号发现与趋势变化", "归因树和行动优先级"], tag: "洞察分析" },
        ...
        "executive-deepblue-boardroom": { date: "2026/07/14", kicker: "BOARD BRIEF", title: "经营决策", lines: ["经营概览与关键指标", "问题诊断与行动计划"], tag: "决策汇报" },
    ...
    function normalizedTemplateVisual(visual = {}) {
      return {
        ...
        layout: ["top-band", "left-rail", "hero", "executive", "academy", "venture", "marketing", "social-video-growth", "pre-a-market-validation", "status-report", "red-gold", "education-course", "public-course-enrollment", "feature-priority-matrix", "experience-journey-map", "capability-radar-map", "product-interview-insight", "startup-product-highlights", "investor-update-progress-sync", "pitch-project-return", "enterprise-digital-blueprint", "business-model-value-chain", "product-pricing-strategy", "channel-recruitment-policy", "operating-problem-tree", "knowledge-blackboard", "exam-review-keypoints", "corporate-training", "onboarding-guide", "annual-summary", "quarterly-dashboard", "quarterly-diagnosis", "quarterly-action-loop", "industry-research", "industry-trend-forecast", "strategy-swot-map", "strategy-region-entry", "sales-enterprise-proposal", "sales-key-account-decision-chain", "sales-training-objection-handling", "presales-architecture-solution", "bi-executive-cockpit", "executive-deepblue-boardroom", "user-path-funnel", "market-trend-radar", "channel-traffic-quality", "data-governance-standard", "data-insight-dashboard-console", "data-insight-workbench", "brand-story-editorial", "brand-identity-system", "luxury-brand-story"].includes(visual.layout) ? visual.layout : "top-band",
    ...
    function resolveTemplateCardVisual(baseVisual, theme, fallbackVisual) {
      ...
      const merged = {
        ...
        layout: ["top-band", "left-rail", "hero", "executive", "academy", "venture", "marketing", "social-video-growth", "pre-a-market-validation", "status-report", "red-gold", "education-course", "public-course-enrollment", "feature-priority-matrix", "experience-journey-map", "capability-radar-map", "product-interview-insight", "startup-product-highlights", "investor-update-progress-sync", "pitch-project-return", "enterprise-digital-blueprint", "business-model-value-chain", "product-pricing-strategy", "channel-recruitment-policy", "operating-problem-tree", "knowledge-blackboard", "exam-review-keypoints", "corporate-training", "onboarding-guide", "annual-summary", "quarterly-dashboard", "quarterly-diagnosis", "quarterly-action-loop", "industry-research", "industry-trend-forecast", "strategy-swot-map", "strategy-region-entry", "sales-enterprise-proposal", "sales-key-account-decision-chain", "sales-training-objection-handling", "presales-architecture-solution", "bi-executive-cockpit", "executive-deepblue-boardroom", "user-path-funnel", "market-trend-radar", "channel-traffic-quality", "data-governance-standard", "data-insight-dashboard-console", "data-insight-workbench", "brand-story-editorial", "brand-identity-system", "luxury-brand-story"].includes(theme.visual.layout)
          ? theme.visual.layout
          : baseVisual.layout,
