...
```md
创建一个 goal：使用 PPT 模板开发 Agent 工作流，开发一个 AI-PPT 官方模板，模板分类【】、模板名称【】、主题风格【】、使用场景【】、参考图片【有/无】。要求先输出设计方案让我确认，确认后再生成原创贴图、实现模板代码、校验在线预览和导出 PPTX、同步后台模板管理，并提交远程仓库。
```
